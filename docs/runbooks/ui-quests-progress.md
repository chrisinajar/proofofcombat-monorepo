---
id: ui-quests-progress
description: UI guidance for interpreting Quest Log state, with special notes for Rebirth and Washed Up
owner: ui
triggers:
  - proofofcombat-ui/src/game/quest-log/**
  - proofofcombat-ui/src/game/index.tsx
  - proofofcombat-ui/src/me.graphql
checklist:
  - Use generated hooks; no inline gql in UI
  - Read quest progress via QuestLog fields (started/finished/progress)
  - Detect first rebirth completion via hero.levelCap > 10, not hero.version
  - Do not hide onboarding solely due to Washed Up starting
source: runbook
---
